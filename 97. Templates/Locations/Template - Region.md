...
> [!infobox | no-blending black]+ <font color="#f7f7f7">`=this.file.name`</font>
>
> ![[PlaceholderRegion.png]]
>
> # Info
> | | |
> | --- | --- |
...
<font color="#f7f7f7"> Write a brief summary of the region, highlighting it's defining features, climate, and overall significance.</font>
...
> id: Example
> image:
> - [[PlaceholderImage.jpg|Main]]
> imageOverlay:
> - [[[PlaceholderImage.jpg|TBD]]]
> lock: true
> recenter: true
> noscrollZoom: false
